...
const VendasPorPeriodo = () => {
    ...
    const buscarRelatorio = async () => {
        ...
        try {
            ...
            const response = await fetch("http://127.0.0.1:3000/relatorios/vendas/periodo", {
                method: "POST",
                headers: {
                        ...
                        <div className="resumo-container">
                            ...
                            <div className="resumo-cards">
                                <div className="resumo-card">
                                    ...
                                    <p className="resumo-valor">{relatorio.resumo.total_vendas}</p>
                                </div>
                                <div className="resumo-card">
                                    <h3>Valor Total</h3>
                            ...
                            <div className="periodo-info">
                                <p>
                                    Período: {relatorio.resumo.data_inicio} até {relatorio.resumo.data_fim}
                                </p>
                            </div>
                        </div>
                                    ...
                                    {vendaSelecionada === venda.id_venda && (
                                        <div className="venda-detalhes">
                                            <div className="detalhes-info">
                                                ...
                                                <div className="info-row">
                                                    <strong>Margem Comissão:</strong> {venda.margem_comissao}%
                                                </div>
                                                {venda.observacoes_venda && (
                                                    <div className="info-row">
                                                        <strong>Observações:</strong> {venda.observacoes_venda}
                                                    </div>
                                                )}
                                            </div>
                                                    ...
                                                    <tbody>
                                                        {venda.itens.map((item) => (
                                                            <tr key={item.id_item_venda}>
                                                                ...
                                                                <td>{item.produto}</td>
                                                                <td>
                                                                    {parseFloat(item.quantidade).toFixed(3)} {item.unidade_medida}
                                                                </td>
